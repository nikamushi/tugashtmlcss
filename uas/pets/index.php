...
$pets = mysqli_query($conn, "SELECT pets.*, owners.nama AS pemilik FROM pets JOIN owners ON pets.owner_id = owners.id ORDER BY pets.id ASC");
...
<head>
    ...
    <title>Data Hewan - Pet Management</title>
    ...
    <div class="container py-4">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h4 class="fw-bold mb-0">
                <i class="bi bi-piggy-bank-fill me-2"></i>Data Hewan Peliharaan
            </h4>
                            ...
                            <?php if (mysqli_num_rows($pets) > 0) : ?>
                                ...
                                <?php while ($row = mysqli_fetch_assoc($pets)) : ?>
                                    <tr>
                                        ...
                                        <td><?= $row["pemilik"]; ?></td>
                                        <td>
                                            <img src="../img/<?= $row["foto"]; ?>" alt="Foto" width="80" class="rounded">
                                        </td>
                                        <td>
